...
queryToKafka = taxiTripsEnrich\
    ...
    .option("checkpointLocation", "s3a://taxi-trips-tfm/checkpointKafka") \
    .outputMode("Append") \
    .start()
...
queryToHDFS = taxiTrips.writeStream \
        ...
        .option("path", "s3a://taxi-trips-tfm/trips-events") \
        .option("checkpointLocation", "s3a://taxi-trips-tfm/checkpointHDFS") \
        .outputMode("Append") \
        .start()
